	...
	while (true)
	{
		...
		else if ((G_ONMISSION == 0) && (G_LAWYER == 3))
		{
			...
			if ((PlayR < 1.5) && (!IS_CHAR_SITTING_IN_ANY_CAR(GetPlayerPed())))
			{
				...
				uint PedM1 = MODEL_M_M_GTRI_HI_01;
				uint PedM2 = MODEL_M_M_BUSINESS_03;
				uint PedM3 = MODEL_F_M_PJERSEY_01;
				...
				CREATE_CHAR(26, PedM1, 290.473, -785.685, 5.19, &ped1, TRUE);
				CREATE_CHAR(26, PedM2, 623.574, -493.928, 5.386, &ped2, TRUE);
				CREATE_CHAR(26, PedM3, 623.574, -493.021, 5.386, &ped3, TRUE);
		...
		else if ((G_ONMISSION == 0) && (G_LAWYER == 4))
		{
			...
			if ((PlayR < 1.5) && (!IS_CHAR_SITTING_IN_ANY_CAR(GetPlayerPed())))
			{
				...
				uint PedM2 = MODEL_IG_TUNA;
				uint PedM3 = MODEL_IG_VINNY_SPAZ;
