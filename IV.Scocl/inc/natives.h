...
extern uint REGISTER_SAVE_HOUSE(float x, float y, float z, float rotation, char* name, uint savehouse);
...
extern void CREATE_PICKUP_ROTATE(uint model, uint pickupType, uint ammo, float x, float y, float z, float rX, float rY, float rZ, Pickup *pPickup);
extern void CREATE_PICKUP_WITH_AMMO(uint model, uint pickupType, uint ammo, float x, float y, float z, Pickup *pPickup);
...
extern uint CREATE_CHECKPOINT(int type, float x1, float y1, float z1, float x2, float y2, float z2, float);
...
extern void CREATE_CAR_GENERATOR(float x, float y, float z, float angle, float, float, uint model, int color1, int color2, int color3, int color4, int, boolean alarm, boolean doorlock, int *handle);
...
extern void TASK_PLAY_ANIM_SECONDARY_NO_INTERRUPT(Ped ped, char* animName, char* animGroup, float playbackSpeed, boolean flag1, boolean flag2, boolean flag3, boolean flag4, int unk0);
...
extern void TASK_CHAR_SLIDE_TO_COORD(Ped ped, float x, float y, float z, float heading, float speed);
...
extern void TASK_CAR_DRIVE_TO_COORD(Ped ped, Car car, float x, float y, float z, float speed, int unk0_1, int unk1_0, int unk2_0, float unk3, int unk4);
...
extern void TASK_PLAY_ANIM_SECONDARY_UPPER_BODY(Ped ped, char* animName, char* animGroup, float playbackSpeed, boolean flag1, boolean flag2, boolean flag3, boolean flag4, int unk0);
...
extern void TASK_PLAY_ANIM_UPPER_BODY(Ped ped, char* animName, char* animGroup, float playbackSpeed, boolean flag1, boolean flag2, boolean flag3, boolean flag4, int unk0);
...
extern void TASK_GO_TO_COORD_WHILE_AIMING(Ped ped, float toX, float toY, float toZ, int moveType, int unk0, int unk1, int targetType, float aimX, float aimY, float aimZ, Ped targetPed);
extern void TASK_FALL_AND_GET_UP(Ped ped, ScriptAny, ScriptAny);
extern void TASK_PLAY_ANIM(Ped ped, char* animName, char* animGroup, float delta, boolean loop, float x, float y, float z, int ms);
extern void TASK_SHOOT_AT_COORD(Ped ped, float x, float y, float z, uint time, uint unknown);
...
extern void TASK_LEAVE_CAR_AND_FLEE(Ped ped, Car car, float fromX, float fromY, float fromZ);
...
extern void TASK_PLAY_ANIM_WITH_ADVANCED_FLAGS(Ped ped, char* animName, char* animGroup, float delta, int, int, int, int, int, int, int, int);
