...
void main(void)
{
	...
	ADD_POLICE_RESTART(831.488, 63.0072, 5.98145, -45.0, 0);
	ADD_POLICE_RESTART(-438.639, -150.309, 5.42567, -50, 0);
	ADD_POLICE_RESTART(-224.47, 1295.06, 5.851, 135, 0);
	ADD_POLICE_RESTART(941.943, 1041.08, 5.54716, 180, 0);
	ADD_HOSPITAL_RESTART(-440.243, 62.9246, 5.29422, -95, 0);
	ADD_HOSPITAL_RESTART(-389.428, 1691.1, 5.29302, 0, 0);
	ADD_HOSPITAL_RESTART(320.068, -433.964, 4.70675, -85, 0);
	ADD_HOSPITAL_RESTART(925.961, 1235.05, 6.33435, 80, 0);
